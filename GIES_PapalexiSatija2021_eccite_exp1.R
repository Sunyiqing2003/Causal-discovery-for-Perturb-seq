...
working_residuals <- read.csv("D:/SummerIntern/Datasets/PapalexiSatija2021_eccite_RNA_working residuals_exp1.csv", header = TRUE)
...
result <- confusionMatrix(factor(est_adj), factor(adj_mat),positive = NULL)
print(result)
